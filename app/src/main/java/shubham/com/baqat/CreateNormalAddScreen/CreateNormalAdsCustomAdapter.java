...
public class CreateNormalAdsCustomAdapter extends BaseAdapter  {
    Context context;
    ArrayList<Info> OccationList;
    LayoutInflater inflter;

    public CreateNormalAdsCustomAdapter(Context applicationContext, ArrayList<Info> OccationList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.createnormal_custom_spinner_items, null);
