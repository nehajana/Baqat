...
public class CreateNormalAdsCustomAdapterTwo extends BaseAdapter  {
    Context context;
    ArrayList<Info> OccationList;
    LayoutInflater inflter;

    public CreateNormalAdsCustomAdapterTwo(Context applicationContext, ArrayList<Info> OccationList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.createnormal_custom_spinner_items_two, null);
